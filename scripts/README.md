...
```bash
# Clone group repo first
git clone https://github.com/wintwah-lwin/CP3405_Group_4.git

# Run fetch and push to evidence/Week 24/
python run_weekly_fetch.py --week 24 --repo ../CP3405_Group_4
```
